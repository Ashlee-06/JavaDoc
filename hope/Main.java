...
/**
 * The {@code Main} class provides the entry point for the Goa Online Services application.
 * It handles user interactions, including registration, login, viewing services, 
 * submitting applications, making payments, sending notifications, submitting feedback, 
 * and viewing departments.
 */
public class Main {

    /**
     * The main method runs the interactive console application.
     * It allows users to select different options to interact with various services and functionalities.
     *
    ...
    public static void main(String[] args) {
        ...
        Service service2 = new Service(102, "Driving License", "Issuance of Driving License", 2, 200.0, "Application Form, ID Proof");
